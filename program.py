...
from gui_userinterface import EmployeeListWindow
...
def main(*args):
    ...
    # Use new GUI User Interface
    # Make instance of main window
    main_window = EmployeeListWindow(
        beverage_collection,
        csv_processor,
        PATH_TO_CSV,
    )
    # Call run method on main window.
    main_window.run()
